          ...
          <section className={styles.product__info}>
            ...
            <div className={styles.product__design}>
              ...
              <div className={styles.product__colors}>
                <div className={`${styles.product__color} ${styles.product__color_active}`}>
                  <span>black</span>
                  <div style={{ backgroundColor: 'black' }}></div>
                </div>
                <div className={styles.product__color}>
                  <span>cotton_candy</span>
                  <div style={{ backgroundColor: '#F4B7BF' }}></div>
                </div>
                <div className={styles.product__color}>
                  <span>papaya</span>
                  <div style={{ backgroundColor: '#FE8D55' }}></div>
                </div>
                <div className={styles.product__color}>
                  <span>turquoise</span>
                  <div style={{ backgroundColor: '#8DDAE4' }}></div>
                </div>
                <div className={styles.product__color}>
                  <span>yellow</span>
            ...
            <div className={styles.product__characteristic}>
              ...
              <ul style={{ height: '96px' }}>
                ...
                <li>
                  Praesent efficitur, massa et pulvinar aliquam, tortor metus fringilla ligula, nec semper dolor nibh a diam. Sed
                  vel elementum augue.
                </li>
